        ...
        <>
          <div className="headingView">
            <h3 style={{ display: "inline-block" }}>
              Reporter Name :&nbsp;{cropDetials.reporter}
            </h3>
            <br />
            <h3 style={{ display: "inline-block" }}>
              Plot No :&nbsp; {cropDetials.plotNumber}
            </h3>
          </div>
          <br />
          <hr />
          ...
          {diseaseData.length ? (
            <>
              ...
              <div className="diseaseImageDiv">{diseaseImage}</div>
            </>
          ) : null}
          <br />
          <br />
          <hr className="newLine" />
          {
            ...
            pestData.length ? (
              <>
                ...
                <div className="pestImageDiv">{pestImage}</div>
              </>
            ) : null
          }
          <br />
          ...
          <hr className="newLine" />
          {
            ...
            soilHealthData.length ? (
              <>
                ...
                <div className="soilHealthImageDiv">{soilHealthImage}</div>
              </>
            ) : null
          }
          <br />
          ...
          <hr className="newLine" />
          {
            ...
            cropDetials.plantHealth ? (
              <>
                ...
                <div className="plantHealthImageDiv">{plantHealthImage}</div>
              </>
            ) : null
          }
          <hr className="newLine" />
          {
            ...
            cropDetials.other ? (
              <>
                ...
                <div className="otherImageDiv">{otherImage}</div>
              </>
            ) : null
          }
        </>
